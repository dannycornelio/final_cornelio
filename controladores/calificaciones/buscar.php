...
<div class="container mt-5">
        ...
        <div class="col-lg-8">
            <table class="table table-bordered table-hover">
                <thead class="table-dark">
                    <tr>
                        <h1 class="text-center" style="background-color: black; color: white;">CALIFICACION DEL ALUMNO
                        </h1>
                    </tr>
                </thead>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-4">
            <a href="/final_cornelio/vistas/calificaciones/buscar.php" class="btn btn-info w-100">Volver al
                formulario</a>
        </div>
    </div>
</div>
